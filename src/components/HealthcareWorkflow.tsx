...
const HealthcareWorkflow: React.FC<WorkflowProps> = ({ title, steps }) => {
  return (
    <section className="py-20 px-4 md:px-16 lg:px-48 bg-[#0d0f12] text-white">
      <div className="container mx-auto px-6">

        <h2 className="text-4xl md:text-4xl font-bold text-center text-gradient-primary mb-14">
          {title}
        </h2>
          ...
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-gray-400 text-[14px] mt-1 leading-relaxed max-w-[420px] z-[0]">
                  {step.description}
                </p>
              </div>
            );
