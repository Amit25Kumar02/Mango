// import { Lightbulb, Target, Server, Monitor, Users, Cloud, Database, Shield, Network, ArrowRight, Send } from 'lucide-react';
// import {successStories, FlagshipModels, Trainingprograms, ItConsulting, Healthcare, Healthcare2, Startup,Startup2, featuredPrograms, TrainingPrograms, OurValues} from "./index" 
...
//       subtitle: 'Build AI-powered platforms and applications ready to scale globally.',
//       // bannerImage: aiandit,
//       description: 'We are a collective of world-class strategists and IT experts bound together by our deep tech knowledge, infrastructure expertise, and passion for guiding organizations through comprehensive AI and IT transformation.',
//       features: [
...
//             description: "Comprehensive evaluation of your organization's AI readiness and IT infrastructure, identifying opportunities for optimization and potential challenges across all business and technical functions."

//           },
//           {
//             number: 2,
//             title: "End-to-End Implementation Guidance",
//             description: "Hands-on support throughout AI and IT infrastructure execution, ensuring successful adoption, seamless integration, and continuous optimization of all technology initiatives."
...
//       description: "Real results from organizations that partnered with us for their AI and IT transformation journey",
//       data: successStories
//     }
//     },
//     'solutions/data-analytics-and-insights': {
//       title: 'Transform raw data into actionable intelligence',
//       subtitle: 'Transform fragmented data into clean, unified pipelines for seamless AI integration.',
//       // bannerImage: graph,
//       description: 'Unlock the hidden potential in your data with our advanced analytics platform. From complex data processing to intuitive visualizations, we turn information into competitive advantage.',
//       features: [
...
//         description: "We leverage the most advanced analytics tools and platforms to deliver exceptional results",
//         items: [
//         'Python & R', 'Apache Spark', 'Tableau', 'Power BI',
//         'Snowflake', 'AWS Analytics', 'Google Cloud', 'Azure Synapse',
//         'TensorFlow', 'PyTorch', 'Databricks', 'Elasticsearch'
//       ]
//     },
//       section2: {
//       title: "Our Analytics Process",
//       description:"A systematic approach to transforming your data into strategic advantage",
//       items: [
//         {
//           number: 1,
...
//         items: [
//         { icon: Lightbulb, title: 'Data Processing & ETL', description: 'Advanced data extraction, transformation, and loading pipelines that handle massive datasets with precision and speed.', color: 'bg-orange-500' },
//         { icon: Server, title: 'Interactive Dashboards', description: 'Beautiful, responsive dashboards that make complex data accessible to stakeholders at every level of your organization.', color: 'bg-teal-500' },
//         { icon: Monitor, title: 'Predictive Analytics', description: 'Machine learning-powered insights that help you anticipate trends, identify opportunities, and mitigate risks.', color: 'bg-purple-500' },
//         { icon: Users, title: 'Business Intelligence', description: 'Strategic insights that drive decision-making with comprehensive reporting and performance tracking.', color: 'bg-orange-500' },
//         { icon: Cloud, title: 'Customer Analytics', description: 'Deep customer insights including behavior analysis, segmentation, and lifetime value optimization.', color: 'bg-orange-500' },
//         { icon: Database, title: 'Real-time Monitoring', description: 'Live data streams and alerts that keep you informed of critical business metrics as they happen.', color: 'bg-teal-500' },
//       ]
//     },
//     },
...
//       // bannerImage: edtech,
//       title: 'EduMind AI',
//       subtitle: 'Personalized learning platform with adaptive AI tutoring systems.',
//       description: 'Personalized learning platform with adaptive AI tutoring systems that revolutionize education through intelligent, data-driven instruction.',
//       features: [
...
//       title: 'GreenTrack',
//       subtitle: 'Carbon footprint tracking and sustainability optimization for businesses.',
//       description: 'Carbon footprint tracking and sustainability optimization platform for businesses committed to environmental responsibility and ESG compliance.',
//       features: [
