    ...
    >
      {data.items.map((service, index) => (
        <motion.div
          ...
          className=" rounded-xl p-6 border border-primary/30 hover:border-primary/80 transition-colors duration-300 group cursor-pointer"
        >
          ...
          <p className="text-black text-sm mb-4 leading-relaxed">{service.description}</p>
